...
int main(void)
{
    ...
    do
    {
        ...
        case 6:
            printf("\n-----Listar Informações já cadastradas----\n");
            listInfos();
            break;
...
void cadastrarLoc()
{
    ...
    void baixa_locacao()
    {
        ...
        scanf("%i",&cod);
            ...
            printf("\nDia que o veículo foi retirado:\n");
            scanf("%i",&locacao.data_retirada);
            ...
            printf("Seguro ativado? Caso 1(ativado) Caso 2 (Desativado): \n");
            ...
            else if(locacao.seguro==2 && locacao.dataDevolucaocliente<=locacao.data_devolucao)
            {

                locacao.precoLocTotal= locacao.precoLocTotal;
                printf("Valor a ser pago: %4.f",locacao.precoLocTotal);
            }
